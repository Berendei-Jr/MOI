...
int main()
{
	...
	for (int i = 0; i < 80000; i++) fin.ignore(2, '\n');

	int number_of_iterations = 50;

	char Ch;
	cout << "Choose the mode [0,1]: "; cin >> Ch;
	if (Ch == '0') {
		...
		fou1 << "Overall: " << even_rez << "; " << odd_rez;
		fou1.close();
	}

	else {
		cerr << "Error! Enter the correct number!\n";
		return 0;
	}	
}